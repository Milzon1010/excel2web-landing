...
export default function HomePage() {
        ...
        <section className="grid grid-cols-1 gap-8 mt-4 md:mt-8 md:grid-cols-2">
          ...
          <div>
            <h1 className="text-4xl font-extrabold leading-tight text-slate-900 md:text-5xl">
              Ubah <span className="underline decoration-sky-400 underline-offset-4">Excel</span> → Web-App
          ...
          <div className="p-4 bg-white border shadow-sm rounded-2xl border-slate-200">
            <div className="flex items-center justify-between mb-3">
              <div className="text-xs font-medium text-slate-500">excel-web-app.local</div>
  ...
  {/* daftar FAQ biar gampang dirawat */}
  {[
    {
      q: "Benarkah 48 jam?",
    ...
    },
    {
      ...
      a: "Bisa. Default ID, opsional EN/JP dengan toggle bahasa."
        ...
        <details key={i} className="p-4 mt-3 bg-white border rounded-xl border-slate-200">
