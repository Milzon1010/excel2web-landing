...
export default function Page() {
  return (
    <>
      {/* HEADER */}
      <header className="max-w-6xl mx-auto flex items-center gap-3 py-4 px-4">
        <Image
          src="/logo-allanray.png" // file di /public
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight text-slate-900">
              Ubah <span className="text-sky-600">Excel</span> →{" "}
              <span className="text-slate-800">Web-App</span> dalam{" "}
              <span className="text-sky-600">48 jam</span>.
            </h1>
            <p className="mt-4 text-slate-600">
              Satu file jadi aplikasi web rapi: form, validasi, filter, role user, dan ekspor balik
              ke Excel. Jual putus — tanpa biaya langganan.
            </p>
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-slate-100">
                  <tr>
                    ...
                    <td className="p-3">Contoh A</td>
                    <td className="p-3">Sales</td>
                    <td className="p-3">Aktif</td>
                  </tr>
                  <tr>
                    <td className="p-3">002</td>
                    <td className="p-3">Contoh B</td>
                    <td className="p-3">Ops</td>
                    <td className="p-3">Pending</td>
                  </tr>
                  <tr>
                    <td className="p-3">003</td>
                    <td className="p-3">Contoh C</td>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <ol className="space-y-3">
            <li className="flex gap-3">
              <span className="h-7 w-7 rounded-full bg-sky-600 text-white grid place-content-center text-sm">
                1
              </span>
              <p>
            ...
            <li className="flex gap-3">
              ...
              <p>
                <b>Build & review</b> link staging. Anda cek, kami rapikan.
              </p>
            </li>
            <li className="flex gap-3">
              <span className="h-7 w-7 rounded-full bg-sky-600 text-white grid place-content-center text-sm">
              ...
              <p>
                <b>Serah terima</b>: web-app + user admin + dokumentasi singkat.
              </p>
            </li>
          </ol>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <span
                key={x}
                className="px-3 py-1.5 rounded-full bg-slate-100 text-slate-700 text-sm border border-slate-200"
              >
                {x}
              </span>
            ))}
      ...
      <section className="px-4 sm:px-6 md:px-10 py-10">
        <div className="max-w-4xl mx-auto rounded-2xl border border-slate-200 bg-white p-6 text-center">
          ...
          <div className="text-4xl font-extrabold text-slate-900 my-2">
            Rp <span className="text-sky-600">—</span>
          </div>
          ...
          <p className="mt-3 text-xs text-slate-500">
            Garansi rapi fungsional: kalau tidak sesuai scope disepakati, kami revisi tanpa biaya.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              ...
              ["Bisa multi-user & izin berbeda?", "Bisa: Viewer/Editor/Admin. Tambahan peran bisa didiskusikan."],
              ["Bisa impor/update berkala?", "Bisa impor ulang dari Excel dengan template yang sama."],
              [
                "Berapa lama pengerjaan?",
                "Target 48 jam kerja untuk paket dasar (1 file, 5 form). Scope lebih besar menyesuaikan.",
              ],
              ["Bisa integrasi QGIS/GeoJSON?", "Bisa (opsional). Cocok untuk peta lokasi, wilayah, dsb."],
              [
      ...
      <section className="px-4 sm:px-6 md:px-10 pb-12">
        ...
        <p className="mt-3 text-center text-xs text-slate-500">
          © {new Date().getFullYear()} Allanray TechSight
        </p>
      </section>
    </>
  );
